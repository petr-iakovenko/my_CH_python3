"""
Классы - 8 часть (дополнительный пример):

Выполнение задачи
"""

# Задание:
# Имплементируйте в код из 8 части классов следующий функционал:
...
# решение (классы очень вариативны, решение может отличаться)
